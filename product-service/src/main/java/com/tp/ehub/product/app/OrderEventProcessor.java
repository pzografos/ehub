...
public class OrderEventProcessor extends AbstractMessageProcessor<UUID, OrderEvent> implements OrderEvent.ConsumerVisitor {
	...
	@Override
	public void fallback(OrderEvent event) {
		// TODO Auto-generated method stub
