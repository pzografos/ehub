...
public class ConsumerGroupKafkaReceiver<K, M extends Message> implements GlobalMessageReceiver<K, M> {
	...
	protected Map<String, Object> consumerProps(String groupId, boolean fromStart) {
		return Map.ofEntries(new AbstractMap.SimpleEntry<>(ConsumerConfig.MAX_POLL_INTERVAL_MS_CONFIG, String.valueOf(500L)),
				new AbstractMap.SimpleEntry<>(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, kafka.getBrokers()), new AbstractMap.SimpleEntry<>(ConsumerConfig.GROUP_ID_CONFIG, groupId),
